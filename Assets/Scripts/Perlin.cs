...
{
    public static float Noise(Vector2 coord) => Noise(coord.x, coord.y);
    public static float Noise(Vector3 coord) => Noise(coord.x, coord.y, coord.z);
    ...
    public static float Fbm(float x, float y, int octave) => Fbm(new Vector2(x, y), octave);
    public static float Fbm(float x, float y, float z, int octave) => Fbm(new Vector3(x, y, z), octave);
